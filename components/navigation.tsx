  ...
  const socialLinks = [
    {
      name: 'GitHub',
      href:
        process.env.NEXT_PUBLIC_GITHUB_URL || 'https://github.com/debrightess',
    ...
    {
      name: 'Twitter',
      href: process.env.NEXT_PUBLIC_TWITTER_URL || 'https://x.com/debrightess',
      icon: <Twitter className='w-5 h-5' />,
    },
    {
      name: 'Email',
      href: `mailto:${
        process.env.NEXT_PUBLIC_EMAIL || 'debrightess@gmail.com'
      }`,
          ...
          <div className='hidden md:flex items-center space-x-8'>
            ...
            <GradientMagicButton
              href={
                ...
                'https://docs.google.com/document/d/15EyX05Sg4k-fDOvEoEWjR53yjP_r_xHh9LBwLj3ldOE/edit?usp=sharing'
              }
              className={cn(
